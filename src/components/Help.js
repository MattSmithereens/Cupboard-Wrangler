...
const Help = () => (
  <div className='top-buffer'>
    ...
    <p>I built this to help my wife and I out when it comes to stocking our kitchen.  My wife and I are on entirely different schedules. Oftentimes chores are done by one while the other is either at work or sleeping. Confusion will occur regarding food shopping where one of us will not buy something that the other needs, or we'll both buy it because or a communication breakdown and be left with a glut of something.</p>
