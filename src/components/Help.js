...
const Help = () => (
  <div className='top-buffer'>
    <p className='about-text'>Thanks for checking out out <b>Cupboard Wrangler</b>!</p>
    <p className='about-text' className='about-text'>I built this to help my wife and I out when it comes to stocking our kitchen.  Seeing as the two of us are on entirely different schedules, oftentimes chores are done by one while the other is either at work or sleeping. Confusion will occur regarding food shopping where one of us will not buy something that the other needs, or we'll both buy it concurrently because or a communication breakdown and be left with a glut of something.</p>
    <p className='about-text'>Another compounding factor is that if one of us buys something that the other is unaware of, often times it will languish in the pantry or refrigerator and go bad before it gets eaten.  This app addresses a few of those concerns by allowing us to keep a tally of what we have versus what we need.  If we buy something, it's time stamped so we know if it's on the verge of not being fresh anymore.</p>
    <p className='about-text'>To start, begin adding items.  They'll appear in your shopping list.  From there you can toggle them to your pantry list when you purchase them and toggle them back to your shopping list when you no longer have that item in your pantry.  Items are rendered in order of date with older items appearing higher in the list</p>
    <p className='about-text'>This app is still in beta, but fixes, new features and a new layout (yikes) are in the works.</p>
    ...
    <ul className='about-text'>
      ...
      <li><strike>Make design responsive (it's presently hardcoded for mobile) </strike><span className='red'>Added 5/15/19 but still in progress; I'm in the process of improving the NavBar</span></li>
      ...
      <li>Integration of a barcode reader to more easily add items to the list</li>
    ...
    <p className='about-text'>Feel free to check out the <a href="https://github.com/MattSmithereens/Cupboard-Wrangler" target='_new'>Github Repository</a> or <a href="mailto:mattsmithereens@gmail.com?subject=Cupboard Wrangler">shoot me an email</a>.</p>
  </div>
);
