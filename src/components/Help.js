...
const Help = () => (
  <div className='top-buffer'>
    ...
    <p>I built this to help my wife and I out when it comes to stocking our kitchen.  My wife and I are on entirely different schedules. Oftentimes chores are done by one while the other is either at work or sleeping. Miscommunications will occur regarding food shopping where one of us will not buy something that the other needs, or we'll both buy it because or a communication breakdown. Another compounding factor is that if one of us buys something that the other is unaware of, often times it will languish in the pantry or refridgerator and go bad before it gets eaten.  This app addresses a few of those concerns by allowing us to keep a tally of what we have versus what we need.  If we buy something, it's time stamped so we know if it's on the verge of not being fresh anymore.</p>
